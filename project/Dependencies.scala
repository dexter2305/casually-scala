...
object Dependencies {
  ...
  lazy val cats_laws            = "org.typelevel" %% "cats-laws"            % Version.CatsCoreVersion
  lazy val discipline_core      = "org.typelevel" %% "discipline-core"      % Version.DisciplineVersion
  lazy val discipline_scalatest = "org.typelevel" %% "discipline-scalatest" % Version.DisciplineScalatestVersion
  ...
  lazy val tapir_http4sServer_interpreter =
    "com.softwaremill.sttp.tapir" %% "tapir-http4s-server" % Version.TapirVersion
